...
:.blkdata       cmpr.v  a:REG_TLENGTH v:#h07                        ; Do we have less than eight words to print?
...
:.blkloop       move.v  d:%Yw v:#h20              
                ...
                push.r  s:%Yw
                call.s  a:lemon_putn
                pops.r  d:REG_CURADDR                               ; Print a data word
                ...
                brch.a  c:%EQL a:.blkloop                           ; If not, (rinse lather) repeat
